            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        <h2 className='text-5xl font-bold text-gray-300'>Affordable Price For Your Dream Property</h2>
                        <p className='text-gray-300'>There are many variations of property are available here, Choose your dream property here!!!</p>
                        <div>
                            <Link to='/allproperty'><button className="btn  mr-5">Discover More</button></Link>
