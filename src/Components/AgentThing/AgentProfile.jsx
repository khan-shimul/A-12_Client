...
{user?.photoURL? <img className="w-24 rounded-full  " src={user?.photoURL} alt="" />:  <div >
	...
	<div className="space-y-4 text-center divide-y dark:divide-gray-300">
		<div className="my-2 space-y-1">
			...
			<p className="px-5 text-2xl sm:text-base dark:text-gray-600 font-semibold"><span className='text-xl mr-1 text-orange-500'>Profession:</span> Property Agent </p>
			...
			<p className="px-5 text-2xl sm:text-base dark:text-gray-600 font-semibold"><span className='text-xl mr-1 text-orange-500'>Role:</span> Agent!!</p>
		</div>
