...
const ShowAdvertise = () => {
    ...
    return (
        ...
        className='bg-gray-200 my-10 rounded-lg'>
            <div className='text-center py-10 '> <h1 className='text-3xl font-bold text-orange-400 mt-5 animate__animated animate__backInDown'>Our Best Property is Here!!</h1></div>
