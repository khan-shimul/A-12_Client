...
const ShowAdvertise = () => {
    ...
    return (
        <div className='bg-gray-200 my-10 rounded-lg'>
            <div className='text-center py-10 '> <h1 className='text-3xl font-bold text-orange-400 mt-5'>Our Best Property In Here!!</h1></div>
