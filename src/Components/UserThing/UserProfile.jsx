...
<p className="px-5 text-2xl sm:text-base dark:text-gray-600 font-semibold"><span className='text-xl mr-1 text-orange-500'>Profession:</span> MERN-stack Developer </p>
...
<p className="px-5 text-2xl sm:text-base dark:text-gray-600 font-semibold"><span className='text-xl mr-1 text-orange-500'>Role:</span> Admin!!</p>
</div>
